            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <h3 class="card-title">All Posts &nbsp; 
                            <span class="badge"> {{ $posts->count() }} </span></h3>
                        <div class="toolbar">
                            <a href=" {{ route('admin.post.create') }} " class="btn btn-rose">
                        ...
                        <div class="material-datatables">
                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td> {{ $key + 1 }} </td>
                                        <td> {{ str_limit($post_data->title,20) }} </td>
                                        ...
                                        <td class="text-center">
                                            <a href=" {{ route('admin.post.show',$post_data->id) }} " class="btn btn-sm btn-primary btn-icon"><i class="material-icons" rel="tooltip" data-placement="bottom" title="View">visibility</i></a>
                                            <a href=" {{ route('admin.post.edit',$post_data->id) }} " class="btn btn-sm btn-warning btn-icon  {{ $post_data->user->id == Auth::user()->id ? '': 'disabled' }}"><i class="material-icons" rel="tooltip" data-placement="bottom" title="Edit">edit</i></a>
