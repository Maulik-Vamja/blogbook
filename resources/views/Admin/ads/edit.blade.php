            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <h4 class="card-title">Edit New Offer</h4>
                        <div class="toolbar">
                            
                        </div>
                        <div class="container-fluid">
                        <div class="row text-center">
                            <form method="POST" action="{{ route('admin.ads.update',$offer->id) }} ">
                                {{ csrf_field() }}
                                @method('PUT')
                                <div class="col-md-7 col-md-offset-2">
                                    <div class="form-group label-floating ">
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" value=" {{ $offer->title }} " name="title" placeholder="Enter Offer Title">
                                    </div>
                                    @error('title')
                                ...
                                <div class="col-md-7 col-md-offset-2">
                                    <div class="form-group label-floating ">
                                        <input type="text" name="price" value=" {{ $offer->price }} " class="form-control @error('price') is-invalid @enderror" placeholder="Enter Offer Price">
                                    </div>
                                    @error('price')
                                    <span class="invalid-feedback text-danger text-capitalize" role="alert">
                                        <strong>{{ $message }}</strong>
