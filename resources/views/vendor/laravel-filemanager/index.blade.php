...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{ asset('public/assets/backend/img/72px color.png') }}">
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/css/bootstrap.min.css">
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.5.0/css/all.css">
  <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.css">
  <link rel="stylesheet" href="{{ asset('public/assets/backend/css/cropper.min.css') }}">
  <link rel="stylesheet" href="{{ asset('public/assets/backend/css/dropzone.min.css') }}">
  <link rel="stylesheet" href="{{ asset('public/assets/backend/css/mime-icons.min.css') }}">
  <style>{!! \File::get(base_path('public/assets/backend/css/lfm.css')) !!}</style>
...
<body>
  ...
  <script src="{{ asset('public/assets/backend/js/cropper.min.js') }}"></script>
  <script src="{{ asset('public/assets/backend/js/dropzone.min.js') }}"></script>
  <script>
