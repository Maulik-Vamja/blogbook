                    ...
                    <div class="card-content">
                        ...
                        <div class="container-fluid">
                            <div class="row text-center">
                                <form method="POST" action=" {{ route('author.ads.store') }} "
                                    ...
                                    <div class="col-md-7 col-md-offset-2">
                                        <div class="form-group label-floating ">
                                            <input type="text" value=" {{ old('link') }} " name="link" class="form-control @error('link') is-invalid @enderror" placeholder="Enter url">
                                        </div>
                                        @error('link')
                                        <div class="invalid-feedback text-danger text-capitalize" role="alert">
                                            <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-md-5 col-md-offset-3">
                                        <select class="form-control @error('month') is-invalid @enderror" name="month" id="monthSlider" data-style="btn btn-rose"
                                            data-size="12">
