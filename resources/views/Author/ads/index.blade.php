            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="toolbar">
                            <a href=" {{ route('author.ads.create') }} " class="btn btn-rose">
                        ...
                        <div class="material-datatables">
                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class=" text-center">
                                            @if ($item->trans_status == false)
                                            <a href=" {{ route('author.paynow',$item->id) }} " class="btn btn-sm btn-info btn-icon">Pay Now</a>
                                            @endif
                                            <a href=" {{ route('author.ads.edit',$item->id) }} " class="btn btn-sm btn-warning btn-icon"><i class="material-icons" rel="tooltip" data-placement="bottom" title="Edit">edit</i></a>
                                ...
                                <!------------ Modal ------------------>
                                            ...
                                            <form id="delete-from-{{ $item->id }}" method="POST" action=" {{ route('author.ads.destroy',$item->id) }}">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
                                    ...
                                    <tr class="text-center">
                                        <td colspan="9"><h4>Sorry,You don't have any Advertisment Post. Create Your First Adverrtisment Post.</h4></td>
                                    </tr>
                                    @endif
                                </tbody>
                            </table>
