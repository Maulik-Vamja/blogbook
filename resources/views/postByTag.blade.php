...
<div class="page-header header-filter header-small" data-parallax="true" style="background-image: url(' {{ asset('public/assets/frontend/img/bg2.jpg') }} ');">
    <div class="container">
        <div class="row">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card card-blog">
                        ...
                        <div class="card-content">                    
                            ...
                            <div class="footer">
                                <div class="author">
                                    <a href=" {{ route('profile.index',$post_data->user->id) }} ">
                ...
                @else
                    <div class="container">
                        <div class="title">
                        <h3><strong>Sorry , There have no any post found for {{ $tag->name }}</strong></h3>
                        </div>  
                    </div>
                @endif
            </div>
